...
// Controlla se la variabile di sessione 'user' è impostata
if (!isset($_SESSION['user'])) {
  // La sessione non è attiva, reindirizza alla pagina index.php
  header("Location: index.php");
  exit; // Assicura che lo script termini qui
}

// Se sei qui, la sessione è attiva e puoi continuare con il contenuto della pagina admin.php
?>
<div class="layer"></div>
<!-- ! Body -->
